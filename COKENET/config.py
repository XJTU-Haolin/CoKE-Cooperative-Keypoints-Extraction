...
def get_config():
    parser = argparse.ArgumentParser(description='Train COKENET Architecture')
    
    ## basic configuration
    parser.add_argument('--data-dir', type=str, default='/data0/ZHL/dataset/imagenet2012/', #default='path-to-ImageNet',
    ...
    parser.add_argument('--weights-dir', type=str, default='COKENET/weights',
                            help='The path to save the COKE weights.')
    ...
    parser.add_argument('--network-version', type=str, default='COKENET',
                            help='The COKENET network version name')
    ...
    parser.add_argument('--max-angle', type=int, default=45,
                        help='The max angle value for generating a synthetic view to train COKENET.')
    parser.add_argument('--max-scale', type=int, default=2.0,
                        help='The max scale value for generating a synthetic view to train COKENET.')
    parser.add_argument('--max-shearing', type=int, default=0.8,
                        help='The max shearing value for generating a synthetic view to train COKENET.')
    ...
    parser.add_argument('--init-initial-learning-rate', type=float, default=1e-3,  #1e-3
    ...
    parser.add_argument('--resume-training', type=str, default='/data0/ZHL/project/keynet/COKE/COKENET/pretrained_nets/keyNet.pt',
